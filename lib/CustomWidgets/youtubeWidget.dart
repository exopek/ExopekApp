...
class YoutubeWidget extends StatefulWidget {
  const YoutubeWidget({Key key, this.duration, this.artBoardName, this.showCheckAnimation, this.page, this.lastAnimationValue, this.trainingSeconds, this.pauseSeconds, this.workout, this.position, this.workoutLength, this.nextArtBoardName, this.currentSet, this.sets, this.workoutNext}) : super(key: key);
...
class _YoutubeWidgetState extends State<YoutubeWidget> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    log('videoPath: ${widget.artBoardName}');
    _videoPlayerController = VideoPlayerController.network(widget.artBoardName);
    ...
    _nextvideoPlayerController = VideoPlayerController.network(widget.nextArtBoardName);
        ...
        Future.delayed(Duration(seconds: 0), () {
          setState(() {
            ...
            if (widget.page == widget.workoutLength-1 && widget.currentSet == widget.sets) {
              ...
              _nextchewieController.seekTo(Duration(seconds: 0));
              _chewieController.seekTo(Duration(seconds: 0));
              _nextvideoPlayerController.play();

              //_nextchewieController.play();
  ...
  @override
  void didUpdateWidget(YoutubeWidget oldWidget) {
            ...
            Container(
              ...
              child: AnimatedBuilder(
                  ...
                  builder: (BuildContext context, Widget child) {
                    ...
                    if (_chewieController != null || _nextchewieController != null) {
                        ...
                        children: [
                          ...
                          _showCheckAnimation ? Center(
                            child: Container(
                                //height: 150.0,
                                //width: 150.0,
                                child: !_finish ? _playsecondVideo()//Rive(artboard: _riveArtboardNext,)
                          ...
                          Center(
                            child: Container(
                                //height: 200.0,
                                //width: 200.0,
                                child: _playfirstVideo(),//Rive(artboard: _riveArtboard,)
                            ),
                          )
                        ],
                      );
  ...
  Widget _playfirstVideo() {
    _chewieController.play();
    return Chewie(controller: _chewieController);
  }

  Widget _playsecondVideo() {
    _nextchewieController.play();
    return Chewie(controller: _nextchewieController);
  }
